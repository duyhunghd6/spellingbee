...
[Python](https://ai.google.dev/gemini-api/docs/speech-generation#python)

[JavaScript](https://ai.google.dev/gemini-api/docs/speech-generation#javascript)

[REST](https://ai.google.dev/gemini-api/docs/speech-generation#rest)  
...
transcript \= client.models.generate\_content(  
...
response \= client.models.generate\_content(  
   ...
   config=types.GenerateContentConfig(  
      ...
      speech\_config=types.SpeechConfig(  
         multi\_speaker\_voice\_config=types.MultiSpeakerVoiceConfig(  
            speaker\_voice\_configs=\[  
